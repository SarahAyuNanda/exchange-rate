...
import ExchangeRateByComparison from './containers/Exchange/ComparisonRate';
    ...
    return (
        <Router>
            <Switch>
                ...
                <Route path={PathName.HOME.HISTORY.HISTORY_PERIODE_SYMBOL} component={ExchangeRateByComparison} />
            </Switch>
        </Router>
    );
};
